...
" Edit: Erase underline from tab names with cterm=NONE
highlight TabLine cterm=NONE guifg=#dadada guibg=#606060

" Edit: Remove the white from the tab bar with cterm=NONE
highlight TabLineFill cterm=NONE guifg=#dadada guibg=#606060
